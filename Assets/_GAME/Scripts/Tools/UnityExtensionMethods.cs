...
namespace _GAME.Scripts.Tools
{
    public static class UnityExtensionMethods
    {
        ...
        public static T SetParent<T>(this T behaviour, Transform parent, bool worldPositionStays = true)
        ...
        public static List<GameObject> GetChilds(this GameObject gameObject)
        {
            ...
            foreach (Transform child in gameObject.transform) result.Add(child.gameObject);
            return result;
        }
